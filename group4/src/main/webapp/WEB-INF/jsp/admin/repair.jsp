    ...
    layui.use(['table','form'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {templet :'<div>{{createFormat(d.user.userName)}}</div>', width: 180 ,title: '报修用户昵称'}
                , {templet :'<div>{{createFormat(d.user.tel)}}</div>', width: 180 ,title: '报修用户联系方式'}
                , {templet :'<div>{{createFormat(d.house.call)}}</div>', width: 180 ,title: '房东昵称'}
                , {templet :'<div>{{createFormat(d.house.tel)}}</div>', width: 180 ,title: '房东联系方式'}
        ...
        var $ = layui.$, active = {
            reload: function(){
                ...
                table.reload('testReload', {
                    url:"<%=request.getContextPath()%>/repair/selectRepairBy"
                    ,page: {
                        curr: 1 //重新从第 1 页开始
                    }
                    ,where: {
